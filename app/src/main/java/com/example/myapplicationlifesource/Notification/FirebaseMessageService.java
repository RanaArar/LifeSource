package com.example.myapplicationlifesource.Notification;
...
import com.example.myapplicationlifesource.Donorsinfo;
...
public class FirebaseMessageService extends com.google.firebase.messaging.FirebaseMessagingService {
    ...
    private void sendNotification(String title, String messageBody) {
        Intent intent = new Intent(this, Donorsinfo.class);
